 ...
 *          |------+------+------+------+------+-------------+------+------+------+------+------|
 * tap esc -| Ctrl |   A  |   S  |   D  |   F  |   G  |   H  |   J  |   K  |   L  |   ;  |  "   |
 *          |------+------+------+------+------+------|------+------+------+------+------+------|
...
[_QWERTY] = {
  ...
  {BACKLIT, KC_LCTL, KC_LALT, KC_LGUI, F(2),   KC_SPC,  KC_SPC,  F(3),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
...
[_LOWER] = {
  ...
  {KC_DEL,  KC_LCBR,   KC_LBRC,   KC_PLUS,   KC_MINS,   KC_EQL,   KC_MINS,   KC_EQL,    KC_PLUS,    KC_RBRC, KC_RCBR, KC_PIPE},
  {_______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  S(KC_NUHS), S(KC_NUBS), KC_HOME, KC_END,  KC_ENT},
  {_______, _______, _______, _______, _______, KC_UNDS, _______, _______,    KC_MNXT,    KC_VOLD, KC_VOLU, KC_MPLY}
},
...
const uint16_t PROGMEM fn_actions[] = {
    ...
    [2] = ACTION_LAYER_TAP_KEY(_LOWER, KC_LBRC),
    [3] = ACTION_LAYER_TAP_KEY(_RAISE, KC_RBRC),
